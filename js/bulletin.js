/* ================================================
   ...
   REQUIRED IMPORTS:
     · ./firebase-config.js          (db, auth — dynamic)
     · ./db-paths.js                 (userIndexDoc, barangayId as toBid — dynamic)
     · ./comments.js                 (initComments, buildCommentThread,
                                      restoreOpenThreads)
     ...
     · ./image-viewer.js             (openImageViewer as _openViewer,
                                      _injectImageViewer)
